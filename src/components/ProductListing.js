  ...
  return(
    <TouchableOpacity onPress={ () => props.showProductDetail(props) }>
      <View style={[{backgroundColor: props.color}, styles.container]}>
        ...
        <TouchableOpacity onPress={() => props.removeItemFromCart(props.name)} style={[ { display: props.showRemoveBtn }, styles.minusBtn]}><Text style={styles.minusSign}>-</Text></TouchableOpacity>
      </View>
    </TouchableOpacity>
  )
}
